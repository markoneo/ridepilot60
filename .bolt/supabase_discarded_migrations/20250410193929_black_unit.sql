/*
  # Initial Schema Setup for RidePilot
  ...
  1. New Tables
    ...
    - projects: Store transportation projects
      ...
      - driver_id: Reference to drivers
      - car_type_id: Reference to car_types
      - client_name: Customer name
      - client_phone: Customer contact
      ...
      - payment_status: Payment status (paid/charge)
  ...
  3. Constraints
    - Positive numbers for capacity and price
    - Valid status values
